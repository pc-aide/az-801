...
function attachSolutionButtonListeners_question6(button) {
  button.addEventListener('click', function() {
      ...
      document.querySelectorAll('input[name="question6"]').forEach(radio => {
      ...
      const explanationElement = document.getElementById('explanation_question6');
      if (explanationElement) {
          explanationElement.style.display = 'block';
      }
      const referencesElement = document.getElementById('references_question6');
