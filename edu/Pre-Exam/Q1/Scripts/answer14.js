function attachSolutionButtonListeners_question14(button) {
    button.addEventListener('click', function() {
        ...
        // Check the answer
        const selectedOption = document.querySelector('input[name="answer14"]:checked').value;
        ...
        if (selectedOption !== correctAnswer) {
            allCorrect = false;
            document.querySelector(`input[name="answer14"][value="${selectedOption}"]`).parentElement.style.color = 'red';
        }
