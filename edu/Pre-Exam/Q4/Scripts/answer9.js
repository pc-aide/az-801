...
// Fonction pour attacher les écouteurs d'événements aux boutons de solution pour la question 9
function attachSolutionButtonListeners_question9(button) {
  button.addEventListener('click', function() {
      ...
      const correctAnswers = {
          '9_step1': 'Download & extract the Azure Migrate installer script ZIP file',
          '9_step2': 'Run AzureMigrateInstaller.ps1',
          '9_step3': 'Configure the appliance & register the appliance with Azure Migrate'
      };
