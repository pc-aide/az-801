...
function attachSolutionButtonListeners_question15(button) {
  button.addEventListener('click', function() {
      ...
      const selectedAnswer = document.querySelector('input[name="question15"]:checked');

      // Show correct/incorrect styling
      document.querySelectorAll('input[name="question15"]').forEach(radio => {
      ...
      const explanationElement = document.getElementById('explanation_question15');
      if (explanationElement) {
          explanationElement.style.display = 'block';
      }
      const referencesElement = document.getElementById('references_question15');
